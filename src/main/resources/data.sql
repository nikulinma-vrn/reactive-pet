...
INSERT INTO specialties_vets (vets_id, specialties_id) VALUES (2, 1) ON CONFLICT (vets_id, specialties_id) DO NOTHING;
INSERT INTO specialties_vets (vets_id, specialties_id) VALUES (3, 2) ON CONFLICT (vets_id, specialties_id) DO NOTHING;
INSERT INTO specialties_vets (vets_id, specialties_id) VALUES (3, 3) ON CONFLICT (vets_id, specialties_id) DO NOTHING;
INSERT INTO specialties_vets (vets_id, specialties_id) VALUES (4, 2) ON CONFLICT (vets_id, specialties_id) DO NOTHING;
INSERT INTO specialties_vets (vets_id, specialties_id) VALUES (5, 1) ON CONFLICT (vets_id, specialties_id) DO NOTHING;
...
INSERT INTO visits (pet_id, visit_date, description, assigned_vet_id) SELECT 7, '2010-03-04', 'rabies shot', 1 WHERE NOT EXISTS (SELECT * FROM visits WHERE id=1);
INSERT INTO visits (pet_id, visit_date, description, assigned_vet_id) SELECT 8, '2011-03-04', 'rabies shot', 2 WHERE NOT EXISTS (SELECT * FROM visits WHERE id=2);
INSERT INTO visits (pet_id, visit_date, description, assigned_vet_id) SELECT 8, '2009-06-04', 'neutered', 3 WHERE NOT EXISTS (SELECT * FROM visits WHERE id=3);
INSERT INTO visits (pet_id, visit_date, description, assigned_vet_id) SELECT 7, '2008-09-04', 'spayed', 4 WHERE NOT EXISTS (SELECT * FROM visits WHERE id=4);